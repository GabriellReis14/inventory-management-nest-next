      ...
      <div className="flex flex-column align-items-center justify-content-center">
        ...
        <div style={{ borderRadius: '56px', padding: '0.3rem', background: 'linear-gradient(180deg, rgba(233, 30, 99, 0.4) 10%, rgba(33, 150, 243, 0) 30%)' }}>
          <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
            ...
            <h1 className="text-900 font-bold text-5xl mb-2">Ocorreu algum erro!</h1>
            <div className="text-600 mb-5">Algo está errado, volte mais tarde.</div>
            <img src="/demo/images/error/asset-error.svg" alt="Error" className="mb-5" width="80%" />
            <Button icon="pi pi-arrow-left" label="Voltar para a tela inicial" text onClick={() => router.push('/')} />
          </div>
        </div>
      </div>
    </div>
